...
class Page(ttk.Frame):
    ...
    def title_bar(self, title, show_back=False):
        ...
        ttk.Label(top_frame, text=title, font=("Arial", 24)).grid(row=0, column=0, padx=10, pady=10, sticky="w")
        ...
        ttk.Button(button_frame, text="Settings", command=lambda: self.controller.show_frame("SettingsPage")).grid(row=0, column=1, padx=10, pady=10, sticky="e")
